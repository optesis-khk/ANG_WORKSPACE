...
""",
    ...
    'data': [
        ...
        'report/bon_sortie_external_layout_header.xml',
        'report/bon_sortie_header_view.xml',
        'report/fiche_detenteur_external_layout_header.xml',
        'report/fiche_detenteur_header_view.xml',
        'report/pv_reception_external_layout_header.xml',
        'report/pv_reception_header_view.xml',
        'report/bon_entree.xml',
        'report/livre_journal_external_layout_header.xml',
        'report/livre_journal_header_view.xml',
        'report/livre_journal.xml',
